...
{	
	...
	function flt_user_has_cap( $wp_blogcaps, $orig_reqd_caps, $args ) {
		...
		$this_args = array( 'object_type' => $post_type, 'user' => $user, 'use_term_roles' => $use_term_roles, 'use_object_roles' => $use_object_roles, 'skip_teaser' => true );
		$where = $scoper->query_interceptor->objects_where_role_clauses( 'post', $rs_reqd_caps, $this_args );
