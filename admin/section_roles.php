...
if ( empty($tx->object_source->no_object_roles) ) {
	echo '<li>';
	printf(__('If a role is restricted for some requested %1$s, %2$s and General assignments of that role are ignored.', 'scoper'), $tx->object_source->display_name, $tx->display_name_plural);
	echo '</li>';
}
