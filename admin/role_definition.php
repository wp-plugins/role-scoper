...
if ( empty( $args['customize_defaults'] ) ) {
	...
	//$this->load_role_caps();
	$rs_role_defs->role_caps = apply_filters('define_role_caps_rs', scoper_core_role_caps($any_custom) );
	...
	$rs_role_defs->add_member_objects( scoper_core_role_defs($any_custom) );
...
$rs_default_cap_defs = new WP_Scoped_Capabilities();
$rs_default_cap_defs->add_member_objects( scoper_core_cap_defs($any_custom) );
$rs_default_cap_defs = apply_filters('define_capabilities_rs', $rs_default_cap_defs);

$rs_default_role_defs = new WP_Scoped_Roles($rs_default_cap_defs, $scoper_role_types);

$rs_default_role_defs->role_caps = apply_filters('define_role_caps_rs', scoper_core_role_caps($any_custom) );
...
$rs_default_role_defs->add_member_objects( scoper_core_role_defs($any_custom) );
