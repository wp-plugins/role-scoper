...
if ( scoper_get_option('display_hints') ) {
	...
	_e('These roles are defined by Role Scoper (and possibly other plugins) for use in defining content-specific access.  Although the default capabilities are ideal for most installations, you may modify them at your discretion.', 'scoper');
	echo '</p>';
