...
{	
	...
	function _flt_user_has_cap($wp_blogcaps, $orig_reqd_caps, $args)	{
		...
		if ( in_array( 'edit_others_posts', $reqd_caps ) && ( strpos($script_name, 'p-admin/page.php') || strpos($script_name, 'p-admin/page-new.php') || ( ! empty( $_GET['post_type'] ) && 'page' == $_GET['post_type'] ) ) ) {
		...
		if ( in_array( 'edit_posts', $reqd_caps ) && ( strpos($script_name, 'p-admin/page.php') || strpos($script_name, 'p-admin/page-new.php') || ( ! empty( $_GET['post_type'] ) && 'page' == $_GET['post_type'] ) ) && did_action('admin_notices') ) {
