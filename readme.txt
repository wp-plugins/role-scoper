...
* BugFix : Syntax error on Role Groups administration page
...
= 1.2.11 - 3 Nov 2010 =
* BugFix : Post counts and other dashboard items were not filtered for non-Administrators (since 1.2.10)
...
* BugFix : On WP 3.0 installations with custom post types but no custom taxonomies, fatal error on plugin activation


= 1.2.9.RC2 - 11 Oct 2010 =
...
* Compat : When Revisionary plugin is also active, Contributor / Revisors can publish posts directly without review (since 1.2.9.RC)
...
* BugFix : PHP Warning for "element is not an array" (since 1.2.9.RC)
...
* Change : Raise minimum WP version to 2.7
