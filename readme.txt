...
= How does Role Scoper compare to <a href="http://sourceforge.net/projects/role-manager/">Role Manager</a> or <a href="http://wordpress.org/extend/plugins/capsman/">Capability Manager</a>? =
...
= 1.2.2 - 2 June 2010 =
* BugFix : Category filtering for some widgets and plugins (Subscribe2) was broken (since 1.2) 
...
= 1.1.7 - 15 Feb 2010 =
* BugFix : In Post/Page Edit Form, user checkboxes for role assignment were not sorted alphabetically (since 1.1)
...
= WP-mu Fatal Error =
* BugFix : Fatal error on wp-MU version upgrade, due to failed get_home_path() call (since 1.1)

= File Filtering =
* BugFix : .htaccess file was not regenerated when File Filtering is re-enabled following a disable (since 1.1)
* BugFix : File Filtering was not imposed for new attachments to private / restricted posts (since 1.1)
