...
if ( ! awp_ver('2.7') ) {
	rs_notice('Sorry, this version of Role Scoper requires WordPress 2.7 or higher.  Please upgrade Wordpress or deactivate Role Scoper.  If you must run WP 2.2 - 2.6, try <a href="http://wordpress.org/extend/plugins/role-scoper/download/">Role Scoper 0.9</a>.');
	$bail = 1;	
}
...
if ( ! $bail ) {
	...
	if ( is_admin() && isset( $_POST['enable_group_roles'] ) && strpos( urldecode($_SERVER['REQUEST_URI']), 'admin.php?page=rs-' )  ) {
