...
$output = '<form action="'.get_bloginfo('wpurl').'/wp-login.php" method="post" >';     
	$output .= '<p><label for="user_login">'.__('Username:', 'user-access-manager').'<input name="log" value="'.esc_html(stripslashes($user_login), 1).'" class="input" id="user_login" type="text" /></label></p>';
